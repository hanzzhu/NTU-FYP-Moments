...
public class EditingToolsAdapter extends RecyclerView.Adapter<EditingToolsAdapter.ViewHolder> {
    ...
    public EditingToolsAdapter(OnItemSelected onItemSelected) {
        ...
        //mToolList.add(new ToolModel("Beauty", R.drawable.ic_makeup, ToolType.STICKER));
        mToolList.add(new ToolModel("Rotate", R.drawable.ic_rotation, ToolType.ROTATE));
        mToolList.add(new ToolModel("Adjust", R.drawable.ic_brightness, ToolType.ADJUST));
        mToolList.add(new ToolModel("Draw", R.drawable.ic_oval, ToolType.SHAPE));
