package com.fyp.moments.filters;
...
public class FilterViewAdapter extends RecyclerView.Adapter<FilterViewAdapter.ViewHolder> {
    ...
    private void setupFilters() {
        mPairList.add(new Pair<>("filters/original.png", PhotoFilter.NONE));
        ...
        mPairList.add(new Pair<>("filters/b_n_w.png", PhotoFilter.ENHANCE));
